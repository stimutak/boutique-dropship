// Jest configuration for Docker environment
// Uses real MongoDB container instead of memory server

module.exports = {
  // Test environment
  testEnvironment: 'node',
  
  // Use Docker-specific setup that connects to MongoDB container
  ...
  // Test timeout - increased for Docker environment
  testTimeout: 20000,
